...
2.  在专属加密实例列表中，查看专属加密实例信息，如[图1](#fig367411245418)所示。
    ...
    **图 1**  专属加密实例列表<a name="fig367411245418"></a>  
    ...
    >-   可在“名称“下拉列表中，选择“名称“或者“设备型号“，输入专属加密实例的名称或者设备型号，单击![](figures/zh-cn_image_0112947665.png)，搜索对应的专属加密实例。  
    ...
    **表 1**  专属加密实例参数说明
    ...
    <tr id="row970111411611"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.3.1.1 "><p id="p15703414101613"><a name="p15703414101613"></a><a name="p15703414101613"></a>服务版本</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="83%" headers="mcps1.2.3.1.2 "><div class="p" id="p1718742952911"><a name="p1718742952911"></a><a name="p1718742952911"></a>专属加密实例的状态：<a name="ul628617423211"></a><a name="ul628617423211"></a><ul id="ul628617423211"><li>待实例化<p id="p19185172919409"><a name="p19185172919409"></a><a name="p19185172919409"></a>用户购买的专属加密实例后，尚未对专属加密实例进行实例化，专属加密实例处于<span class="parmvalue" id="parmvalue12405610193913"><a name="parmvalue12405610193913"></a><a name="parmvalue12405610193913"></a>“待实例化”</span>状态。</p>
...
3.  用户可单击专属加密实例的名称，查看实例化后专属加密实例的详细信息，如[图2](#fig967294115113)所示。
    ...
    **表 2**  专属加密实例详细信息参数说明
    ...
    <p id="p42711526333"><a name="p42711526333"></a><a name="p42711526333"></a>可单击<a name="image18293113716336"></a><a name="image18293113716336"></a><span><img id="image18293113716336" src="figures/zh-cn_image_0126753961.png"></span>，修改专属加密实例的名称。</p>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="83%" headers="mcps1.2.3.1.2 "><div class="p" id="p162641345125"><a name="p162641345125"></a><a name="p162641345125"></a>专属加密实例的状态：<a name="dew_01_0042_ul628617423211"></a><a name="dew_01_0042_ul628617423211"></a><ul id="dew_01_0042_ul628617423211"><li>待实例化<p id="dew_01_0042_p19185172919409"><a name="dew_01_0042_p19185172919409"></a><a name="dew_01_0042_p19185172919409"></a>用户购买的专属加密实例后，尚未对专属加密实例进行实例化，专属加密实例处于<span class="parmvalue" id="dew_01_0042_parmvalue12405610193913"><a name="dew_01_0042_parmvalue12405610193913"></a><a name="dew_01_0042_parmvalue12405610193913"></a>“待实例化”</span>状态。</p>
    ...
    <tr id="row132511634131211"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.3.1.1 "><p id="p14252834191219"><a name="p14252834191219"></a><a name="p14252834191219"></a>服务版本</p>
    </td>
    <td class="cellrowborder" valign="top" width="83%" headers="mcps1.2.3.1.2 "><div class="p" id="p12254334101210"><a name="p12254334101210"></a><a name="p12254334101210"></a>基础版、专业版（国内）或者专业版（海外）。<a name="dew_01_0042_ul3963148135310"></a><a name="dew_01_0042_ul3963148135310"></a><ul id="dew_01_0042_ul3963148135310"><li>基础版：用户享有共享机框和电源，在密码运算上独占加密卡的虚拟化专属加密实例。</li><li>专业版（国内）：用户独享硬件加密机机框、电源资源，独享硬件加密机网络带宽、接口资源。</li><li>专业版（海外）：用户独享硬件加密机机框、电源资源，独享硬件加密机网络带宽、接口资源。与专业版（国内）专属加密实例使用的加密算法不同。</li></ul>
    </div>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="83%" headers="mcps1.2.3.1.2 "><p id="p9507451337"><a name="p9507451337"></a><a name="p9507451337"></a>专属加密实例所在的可用分区。</p>
    </td>
    </tr>
    ...
    <tr id="row113318723418"><td class="cellrowborder" valign="top" width="17%" headers="mcps1.2.3.1.1 "><p id="p6342711342"><a name="p6342711342"></a><a name="p6342711342"></a>功能类型</p>
    </td>
