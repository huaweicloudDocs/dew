...
您可以在[API Explorer](https://console.huaweicloud.com/apiexplorer/#/openapi/KMS/doc?api=CreateDatakey)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
<a name="response_CreateDataKeyResponseBody"></a>
...
创建"512"位长度的明文数据密钥，并使用ID为"0d0466b0-e727-4d9c-b35d-f84bb474a37f"的密钥进行加密，返回明文密钥。
