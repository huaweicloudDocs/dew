...
您可以在[API Explorer](https://console.huaweicloud.com/apiexplorer/#/openapi/KMS/doc?api=ShowKeyStore)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。

## URI<a name="atuogenerate_2"></a>

GET /v1.0/\{project\_id\}/keystores/\{keystore\_id\}
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>密钥库ID</p>
</td>
</tr>
</tbody>
</table>
...
<a name="response_ShowKeyStoreResponseBody"></a>
...
<tbody><tr><td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.1 "><p>keystore</p>
</td>
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.4.1.2 "><p><a href="#response_KeystoreDetails">KeystoreDetails</a> object</p>
</td>
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>密钥库详情</p>
</td>
</tr>
</tbody>
</table>
