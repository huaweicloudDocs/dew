...
您可以在[API Explorer](https://console.huaweicloud.com/apiexplorer/#/openapi/KMS/doc?api=ShowVersion)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
<a name="response_ShowVersionResponseBody"></a>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>描述version 对象的列表，详情请参见 ApiVersionDetail字段数据结构说明。</p>
</td>
</tr>
</tbody>
</table>
