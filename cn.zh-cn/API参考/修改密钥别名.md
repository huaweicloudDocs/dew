...
\["服务默认主密钥（密钥别名后缀为“/default”）不可以修改。","密钥处于“计划删除”状态，密钥别名不可以修改。"\]
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>非默认主密钥别名，取值1到255字符，满足正则匹配“^[a-zA-Z0-9:/_-]{1,255}$”且后缀不可以为“/default”。</p>
</td>
</tr>
