# 批量添加删除凭据标签<a name="BatchCreateOrDeleteTags"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CSMS&api=BatchCreateOrDeleteTags)中调试该接口。

## URI

POST /\{version\_id\}/\{project\_id\}/csms/\{secret\_id\}/tags/action
