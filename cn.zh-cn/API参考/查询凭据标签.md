...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CSMS&api=ShowKmsTags)中调试该接口。

## URI

GET /\{version\_id\}/\{project\_id\}/csms/\{secret\_id\}/tags
...
<ul><li><p>key：表示标签键，一个凭据下最多包含10个key，key不能为空，不能重复，同一个key中value不能重复。key最大长度为36个字符。</p>
