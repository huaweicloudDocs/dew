# 添加凭据标签<a name="CreateKmsTag_0"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CSMS&api=CreateKmsTag)中调试该接口。

## URI

POST /\{version\_id\}/\{project\_id\}/csms/\{secret\_id\}/tags
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p><a href="#request_TagItem">TagItem</a> object</p>
</td>
