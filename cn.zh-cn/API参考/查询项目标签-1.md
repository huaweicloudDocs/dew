...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=CSMS&api=ListKmsTags)中调试该接口。

## URI

GET /\{version\_id\}/\{project\_id\}/csms/tags
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>标签值集合</p>
</td>
</tr>
</tbody>
</table>
