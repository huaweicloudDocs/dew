...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>DEK密文及元数据的16进制字符串。取值为加密数据密钥结果中的cipher_text的值。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>密钥字节长度，取值范围为1~1024。 密钥字节长度，取值为“64”。</p>
</td>
</tr>
