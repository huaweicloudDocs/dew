# 关闭密钥轮换<a name="DisableKeyRotation"></a>
...
您可以在[API Explorer](https://console.huaweicloud.com/apiexplorer/#/openapi/KMS/doc?api=DisableKeyRotation)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
关闭key\_id为0d0466b0-e727-4d9c-b35d-f84bb474a37f的密钥轮换
