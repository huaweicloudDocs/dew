...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>DEK明文和DEK明文的SHA256（32字节），均为16进制字符串表示。 DEK明文（64字节）和DEK明文的SHA256（32字节），均为16进制字符串表示</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>DEK明文字节长度，取值范围为1~1024。 DEK明文字节长度，取值为“64”。</p>
</td>
</tr>
...
```
{
  ...
  "plain_text" : "000000000000000000XXXXXXXXX...",
