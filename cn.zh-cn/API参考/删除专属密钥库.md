# 删除专属密钥库<a name="DeleteKeyStore"></a>
...
您可以在[API Explorer](https://console.huaweicloud.com/apiexplorer/#/openapi/KMS/doc?api=DeleteKeyStore)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。

## URI<a name="atuogenerate_2"></a>

DELETE /v1.0/\{project\_id\}/keystores/\{keystore\_id\}
...
<tbody><tr><td class="cellrowborder" valign="top" width="15%" headers="mcps1.1.3.1.1 "><p>400</p>
</td>
