...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=KMS&api=BatchCreateKmsTags)中调试该接口。
...
<td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.5.1.4 "><p>操作标识： 仅限于“create”和“delete”。</p>
</td>
</tr>
