...
您可以在[API Explorer](https://console.huaweicloud.com/apiexplorer/#/openapi/KMS/doc?api=ShowUserQuotas)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
<a name="response_UserQuotasResponseBody"></a>
...
<td class="cellrowborder" valign="top" width="60%" headers="mcps1.2.4.1.3 "><p>资源配额列表，详情请参见Resources</p>
</td>
</tr>
</tbody>
</table>
...
查询项目ID为0dea2644dc80d5d22ff1c01e3ebea6fc已使用的配额。
