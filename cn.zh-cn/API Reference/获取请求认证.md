...
1.  发送“POST https://_**IAM的Endpoint**_/v3/auth/tokens”。
    ...
    获取IAM的Endpoint及消息体中的区域名称请参见[地区和终端节点](http://developer.huaweicloud.com/dev/endpoint)[地区和终端节点](https://docs.prod-cloud-ocb.orange-business.com/zh-cn/endpoint/index.html)。
...
## AK/SK认证<a name="zh-cn_topic_0091607401_section17023744719"></a>
...
3.  对请求进行签名。
    ...
    4.  发送带有签名信息的请求。
        ...
        示例代码包下载地址：[https://apig-demo.obs.eu-de.otc.t-systems.com/java/SdkDemo.zip](https://apig-demo.obs.eu-de.otc.t-systems.com/java/SdkDemo.zip)
        ...
        示例代码中的region和serviceName（英文服务名缩写），请参考[地区和终端节点](https://docs.prod-cloud-ocb.orange-business.com/zh-cn/endpoint/index.html)。
