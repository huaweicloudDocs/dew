...
1.  单击页面左侧的![](figures/icon-servicelist-16.png)，选择“安全与合规  \>  数据加密服务“，默认进入“密钥管理“界面。
2.  在左侧导航树中，选择“专属加密“，进入专属加密实例列表页面。
3.  在专属加密实例列表中，查看专属加密实例信息，如[图1](#fig367411245418)所示。
...
4.  用户可单击专属加密实例的名称，查看实例化后专属加密实例的详细信息，如[图2](#fig967294115113)所示。
...
5.  查看专属加密实例监控，包括实例健康状态、网络健康状态、网络延迟、CPU使用率、内存使用率、当前连接数。
