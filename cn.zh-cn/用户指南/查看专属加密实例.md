...
3.  用户可单击专属加密实例的名称，查看实例化后专属加密实例的详细信息，如[图2](#fig967294115113)所示。
    ...
    **表 2**  专属加密实例详细信息参数说明
    ...
    <p id="p42711526333"><a name="p42711526333"></a><a name="p42711526333"></a>可单击<a name="image136852037121714"></a><a name="image136852037121714"></a><span><img id="image136852037121714" src="figures/icon_edit.png"></span>，修改专属加密实例的名称。</p>
    </td>
    </tr>
